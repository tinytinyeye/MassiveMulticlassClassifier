...
class MultiClassifier(object):
    ...
    def load_sparse(self, filename, graph, batch_size=505):
        """
        load testing data
        """
        with graph.as_default():
            ...
            try:
              ...
              while not coord.should_stop():
                  ...
                  if min_loss - loss_ > THR:
                      ...
                      stabilized_steps += 1
                  if early_stop is True and stabilized_steps > STOP_THR:
                      break
                  if step % 100 == 0:
                      print('step:', step,
    ...
    def evaluate(self, filename, chunck_size=2417, gpu_option='0', load_probs=False):
        P = None
